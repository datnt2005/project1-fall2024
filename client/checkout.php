                        ...
                        <form action="checkout.php" method="post">
                            <div class="address-delivery">
                                ...
                                <div class="detail-address px-2">
                                    <a href="./address/listAddress.php?id=<?php echo $idUser ?>"
                                        class="add_to--address nav-link d-flex align-item-center ms-2">
                                    ...
                                    <div class="address-content text-secondary">
                                        ...
                                        <p class="vilage-streetName m-0">Ymoal Enuol, Tan Loi</p>
                                        <p class="provine-district m-0">BMT, Dak Lak</p>
                                        <!-- <p class="m-0">Chọn địa điểm giao hàng</p>     -->
                                        <input type="hidden" name="addressOrder" id="addressOrder"
                                            value="<?php echo $idAddress; ?>">
                                        <!-- <?php

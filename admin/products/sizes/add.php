<?php
    ...
    $colors = $dbHelper->select("SELECT * FROM sizes");
    $errors = [];
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(!isset($_POST['nameSize']) || empty($_POST['nameSize'])) {
                $errors['nameSize'] = "Đây là trường bắt buộc <br>" ;
        }
        if (count($errors) == 0) {
            $data = [
                'nameSize' => $_POST['nameSize'],
            ];
            $lastInsertId = $dbHelper->insert('sizes', $data);
            $id = $dbHelper->lastInsertId();
            $_SESSION['success'] = "Bạn đã thêm size thành công";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row ">
                                    ...
                                    <div class="col-md-6">
                                        <h1 class="mt-4">Thêm kích cỡ</h1>
                                        <form action="" method="post">
                                            <div class="nameSize">
                                                <label for="">Kích cỡ</label>
                                                <input type="text" name="nameSize" id="nameSize"
                                                    class="form-control">
                                                <?php
                                            ...
                                            <div class="d-flex justify-content-between mt-3">
                                                ...
                                                <button type="submit" class="btn btn-dark bg-gradient text-white">Thêm kích cỡ
                                                    </button>
                                            </div>
                                        </form>
                                    </div>
